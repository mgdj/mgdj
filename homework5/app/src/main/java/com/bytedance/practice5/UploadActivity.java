                ...
                uploadresponse.enqueue(new Callback<UploadResponse>() {
                    ...
                    public void onResponse(Call<UploadResponse> call, Response<UploadResponse> response) {
                        if (!response.isSuccessful()) {
                            Toast.makeText(UploadActivity.this, "收到回应失败！", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        final UploadResponse upResponse = response.body();
                        if (upResponse == null) {
                            Toast.makeText(UploadActivity.this, "收到回应为空！", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        if (upResponse.success) {
                            ...
                            Toast.makeText(UploadActivity.this, "提交失败: " + upResponse.error, Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<UploadResponse> call, Throwable t) {
                        t.printStackTrace();
                        Toast.makeText(UploadActivity.this, "提交失败" + t.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).start();
...
//                    strBuf.append(coverImageData);
                    ...
                    Toast.makeText(UploadActivity.this, "连接失败" + e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        }).start();
    }
