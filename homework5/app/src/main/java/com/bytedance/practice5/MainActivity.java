...
public class MainActivity extends AppCompatActivity {
    ...
    public List<Message> baseGetMessageFromRemote(String student_id, String accept){
        String add="";
        if(student_id!=null){
            add = String.format("?student_id=%s",student_id);
        }
        String urlstr=String.format("https://api-android-camp.bytedance.com/zju/invoke/messages%s",add);
        ...
        try{
            ...
            conn.setRequestProperty("token",accept);
    ...
    private void getData(String studentId){
        new Thread(new Runnable() {
            @Override
            public void run() {
                List<Message> res = baseGetMessageFromRemote(studentId,token);
