...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content, Priority priority) {
        ...
        value.put(TodoNote.COLUMN_content,content);
        value.put(TodoNote.COLUMN_state,State.TODO.intValue);
        value.put(TodoNote.COLUMN_priority,priority.intValue);
        value.put(TodoNote.COLUMN_date,System.currentTimeMillis());
        long rowid = database.insert(TodoNote.TABLE_NAME,null,value);
